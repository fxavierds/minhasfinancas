...
import com.financas.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.financas.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity<?> atualizar(@PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		...
		}).orElseGet(() -> new ResponseEntity<Object>("Lançamento não encontrado", HttpStatus.BAD_REQUEST));
	}
	...
	private LancamentoDTO converter(Lancamento lancamento) {
		return LancamentoDTO.builder().ano(lancamento.getAno()).descricao(lancamento.getDescricao())
				.id(lancamento.getId()).mes(lancamento.getMes()).status(lancamento.getStatus().name())
				.tipo(lancamento.getTipo().name()).valor(lancamento.getValor()).usuario(lancamento.getUsuario().getId())
				.build();
	}
